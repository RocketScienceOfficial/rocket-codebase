...
def get_environment(dt: float):
    return SequentialReplayEnvironment(
        ...
        time_col="time",
        imu1=ReplayIMUModel(rate=500, acc_x="acc1_x", acc_y="acc1_y", acc_z="acc1_z", gyro_x="gyro1_x", gyro_y="gyro1_y", gyro_z="gyro1_z", acc_range_g=6.0, gyro_range_deg=500.0),
        mag1=ReplayMagnetometerModel(rate=100, mag_x="mag_x", mag_y="mag_y", mag_z="mag_z", scale=1e-3),
