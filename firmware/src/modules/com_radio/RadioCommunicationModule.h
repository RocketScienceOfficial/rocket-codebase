...
class RadioCommunicationModule
{
public:
    void init();
    void run();
...
private:
    PubSub::Publisher<PubSub::Topics::DatalinkMessage> m_Publisher{PUBSUB_ID(radio_rx)};
    PubSub::Subscriber<PubSub::Topics::DatalinkMessage> m_Subscriber{PUBSUB_ID(radio_tx)};
