...
{
    size_t offset_bytes = offsetPages * HAL_FLASH_PAGE_SIZE;
    size_t size_bytes = pagesCount * HAL_FLASH_PAGE_SIZE;
...
{
    size_t offset_bytes = sectorsOffset * HAL_FLASH_SECTOR_SIZE;
    size_t size_bytes = sectorsCount * HAL_FLASH_SECTOR_SIZE;
