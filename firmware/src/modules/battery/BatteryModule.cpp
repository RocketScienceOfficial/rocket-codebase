...
void BatteryModule::run()
{
    ...
    {
        float batteryReading = m_Subscriber.get().rawVoltage;
...
void BatteryModule::accumulateBatteryReading(float reading)
{
...
void BatteryModule::smoothenBatteryVoltage(float &delta)
{
