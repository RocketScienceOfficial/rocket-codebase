...
def get_environment(dt: float):
    return SyntheticEnvironment(
        ...
        imu1=SyntheticIMUModel(rate=500, noise_acc=GaussianNoiseModel(mean=0, std_dev=0.22), noise_gyro=GaussianNoiseModel(mean=0, std_dev=0.17), acc_range_g=12.0, gyro_range_deg=500.0),
